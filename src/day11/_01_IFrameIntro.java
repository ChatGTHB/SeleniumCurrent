...
public class _01_IFrameIntro extends BaseDriver {
    ...
    public void Test() {
        ...
        //driver.switchTo().frame(0);  // It can be passed by giving 24 indexes: index on the page
        //driver.switchTo().frame("frame1"); // You can pass by giving id 20112, but it's slow
        //driver.switchTo().frame("iamframe"); // It can also be passed by giving 163 names, but it's fast
        WebElement frame1 = driver.findElement(By.id("frame1"));
        driver.switchTo().frame(frame1); // You can also export it as 71 weblements, but it's fast.
